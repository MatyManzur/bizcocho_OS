...
typedef enum key_t
{
    ...
    VK_HOME_NUMPAD = 0x47,
    VK_UP_NUMPAD = 0x48,
    VK_PRIOR_NUMPAD = 0x49,
    VK_SUBTRACT = 0x4A,
    VK_LEFT_NUMPAD = 0x4B,
    VK_CLEAR = 0x4C,
    VK_RIGHT_NUMPAD = 0x4D,
    VK_ADD = 0x4E,
    VK_END_NUMPAD = 0x4F,
    VK_DOWN_NUMPAD = 0x50,
    VK_NEXT_NUMPAD = 0x51,
    VK_INSERT_NUMPAD = 0x52,
    VK_DELETE_NUMPAD = 0x53,
    VK_SNAPSHOT = 0x54,
    VK_OEM_102 = 0x56,
    VK_F11 = 0x57,
    VK_F12 = 0x58,
    VK_OEM_WSCTRL = 0x5A,
    VK_DBE_KATAKANA = 0x5B,
    VK_OEM_JUMP = 0x5C,
    VK_DBE_FLUSHSTRING = 0x5D,
    VK_OEM_BACKTAB = 0x5E,
    VK_OEM_AUTO = 0x5F,
    VK_DBE_NOCODEINPUT = 0x62,
    VK_HELP = 0x63,
    VK_F13 = 0x64,
    VK_F14 = 0x65,
    VK_F15 = 0x66,
    ...
    VK_OEM_PA1 = 0x7B,
    VK_ABNT_C2 = 0x7E,
    VK_MEDIA_PREV_TRACK = -0x10,
    VK_MEDIA_NEXT_TRACK = -0x19,
    VK_RETURN_NUMPAD = -0x1C,
    VK_RCONTROL = -0x1D,
    VK_VOLUME_MUTE = -0x20,
    VK_LAUNCH_APP2 = -0x21,
    VK_MEDIA_PLAY_PAUSE = -0x22,
    VK_MEDIA_STOP = -0x24,
    VK_VOLUME_DOWN = -0x2E,
    VK_VOLUME_UP = -0x30,
    VK_BROWSER_HOME = -0x32,
    VK_DIVIDE = -0x35,
    VK_SNAPSHOT_NUMPAD = -0x37,
    VK_RMENU = -0x38,
    VK_CANCEL = -0x46,
    VK_HOME = -0x47,
    VK_UP = -0x48,
    ...
    VK_APPS = -0x5D,
    VK_SLEEP = -0x5F,
    VK_BROWSER_SEARCH = -0x65,
    VK_BROWSER_FAVORITES = -0x66,
    VK_BROWSER_REFRESH = -0x67,
    VK_BROWSER_STOP = -0x68,
    VK_BROWSER_FORWARD = -0x69,
    VK_BROWSER_BACK = -0x6A,
    VK_LAUNCH_APP1 = -0x6B,
    VK_LAUNCH_MAIL = -0x6C,
    VK_LAUNCH_MEDIA_SELECT = -0x6D
} key_t;
